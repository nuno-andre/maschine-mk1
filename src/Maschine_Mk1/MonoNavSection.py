...
from .MIDI_Map import arm_exclusive, QUANT_CONST, REL_KNOB_DOWN
from .KnobSection import calc_new_parm, repeat, CLIQ_DESCR, QUANT_DESCR
...
class MonoNavSection(CompoundComponent):
    ...
    def __init__(self, mode_selector, *args, **kwargs):
    ...
    def _do_channel_selection(self, dir):
        ...
        if self._alt_down:
            if self.canonical_parent.isShiftDown():
                ...
                ndir = (
                    dir == -1 and Live.Application.Application.View.NavDirection.left
