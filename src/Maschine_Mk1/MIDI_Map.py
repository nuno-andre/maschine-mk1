...
def toHSB(rgb_val):
    ...
    color = (
        (hue / 2, min(sat / 2 + 20, 127), bright / 2),
        (hue / 2, min(sat / 2 + 15, 127), max(bright / 2 - 90, 5)),
    )
    _color_table[rgb_val] = color
    return color
...
QUANT_STRING = ['None', '1/4', '1/8', '1/8T', '1/8+1/8T', '1/16', '1/16T', '1/16+1/16T', '1/32']
AUTO_NAME = (
    (re.compile('kick|bd|bassdrum', re.I), ((0, 127, 40), (0, 127, 127))),
    (re.compile('snare|sn|sd', re.I), ((82, 127, 40), (82, 127, 127))),
    (re.compile('tom|tm|strike', re.I), ((12, 127, 40), (12, 127, 127))),
    (re.compile('crash|crsh', re.I), ((100, 94, 40), (100, 94, 127))),
    (re.compile('ride|rd', re.I), ((90, 127, 40), (90, 127, 127))),
    (re.compile('hit|strike|metal', re.I), ((115, 127, 40), (115, 127, 127))),
    (re.compile('shaker|tamb', re.I), ((13, 127, 40), (13, 127, 127))),
    (re.compile('clp|clap|hand|slap', re.I), ((70, 100, 40), (70, 100, 127))),
    (re.compile('rim|rm|stick', re.I), ((85, 94, 40), (85, 94, 127))),
    (re.compile('(bell|tri|gong|clav)', re.I), ((67, 127, 40), (67, 127, 127))),
    (re.compile('(perc|cong|bong|ag)', re.I), ((127, 100, 40), (127, 100, 127))),
    (re.compile('(glitch|fx|noise)', re.I), ((21, 127, 40), (21, 127, 127))),
    (re.compile('((hat|hh)(.*)(cl))|((cl)(.*)(hihat|hh)|ch)', re.I), ((29, 127, 40), (29, 127, 127))),
    (re.compile('((hat|hh)(.*)(op))|((op)(.*)(hihat|hh)|oh)', re.I), ((40, 127, 40), (40, 127, 127))),
    (re.compile('(hh|hat|click)', re.I), ((47, 127, 40), (47, 127, 127))),
)
...
PColor = enum(
    CLIP_PLAY=((36, 127, 127, 1, 1), (36, 100, 30, 1, 0)),
    CLIP_STOPPED=((14, 127, 127, 1, 0), (14, 100, 30, 1, 0)),
    ...
    XFADE_A=((10, 127, 127, 1, 2), (10, 127, 127, 1, 2)),
    XFADE_BOTH=((65, 127, 5, 1, 0), (65, 127, 5, 1, 0)),
    ...
    ARM_NO_ARM=((2, 80, 30, 1, 0), (2, 80, 30, 0, 0)),
