...
class TrackElement:
    ...
    def set_button(self, button, track, mode):
        assert isinstance(mode, TrackModMode)  # FIXME
        assert button == None or isinstance(button, ButtonElement)  # FIXME
        assert track == None or isinstance(track, Live.Track.Track)  # FIXME
        self._track = track
        self._mode = mode
...
class TrackAssign:
    ...
    def __init__(self):
        self.track_offset = 0
        self.elements = tuple(TrackElement(i) for i in range(16))
...
class TrackModMode(MaschineMode):
    ...
    def __init__(self, track_assign, *args, **kwargs):
        super().__init__(*args, **kwargs)
        assert isinstance(track_assign, TrackAssign)  # FIXME
...
class TrackArmMode(TrackModMode):
    ...
    def __init__(self, track_assign, *args, **kwargs):
        super().__init__(track_assign, *args, **kwargs)
        self.exclusive = True
    ...
    def _get_color(self, track_ele):
        ...
        if track == None:
            ...
            if track.can_be_armed:
                onoffindex = track.arm is False and 1 or 0
...
class TrackSoloMode(TrackModMode):
    ...
    def _get_color(self, track_ele):
        ...
        if track == None:
            ...
            return PColor.SOLO_TRACK[(track.solo is False and 1 or 0)]
...
class TrackSelectMode(TrackModMode):
    ...
    def _get_color(self, track_ele):
        ...
        return PColor.SELECT[track != sel_track]
