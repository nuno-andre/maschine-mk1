...
LIVE_COLOR_SET = (
    15549221, 12411136, 11569920, 8754719, 5480241, 695438, 31421, 197631,
...
BASE_COLOR_TABLE = (
    (115, 127, 127, 16726484), (124, 73, 127, 15810688), (3, 127, 118, 15549221),
    (0, 125, 127, 16712965), (81, 110, 114, 5538020), (85, 126, 127, 197631),
    (90, 115, 124, 8940772), (105, 115, 114, 14183652), (33, 100, 127, 8912743),
    (44, 124, 119, 1769263), (55, 119, 127, 2490280), (67, 110, 127, 6094824),
    (9, 125, 123, 16149507), (12, 107, 127, 16753961), (17, 120, 127, 16773172),
    (24, 118, 110, 14939139),
)
BASE_COLOR_TABLE_2 = (
    (0, 127, 127, 16712965), (9, 125, 123, 16149507), (12, 107, 127, 16753961),
    (20, 57, 120, 16772767), (20, 127, 127, 14939139), (33, 120, 127, 8912743),
    (39, 120, 127, 1769263), (46, 127, 90, 5480241), (50, 127, 127, 2490280),
    (62, 127, 127, 6094824), (74, 127, 127, 9160191), (85, 126, 127, 197631),
    (91, 127, 107, 10701741), (111, 127, 127, 16726484), (124, 127, 107, 12008809),
    (127, 86, 127, 16749734),
)
...
class MaschineColorSelectMode(MaschineMode):
    ...
    def __init__(self, button_index, *args, **kwargs):
        ...
        self._color_table = tuple(lst)

    def get_color(self, value, column_index, row_index):
        return PColor.OFF[cindex]  # FIXME
